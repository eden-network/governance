          ...
          <div class="column is-two-fifths">
            ...
            <article class="box is-hidden-mobile">
                ...
                <div class="content is-family-secondary">
                  <p>
                    <b-button type="is-text" tag="a" href="https://gov.edennetwork.io/" target="_blank">
            ...
            <article class="box is-hidden-mobile">
                ...
                <div class="content is-family-secondary">
                  <p>EDEN is now part of SushiSwap Onsen. Earn SUSHI by providing EDEN-ETH liquidity.</p>
                  <p>
          ...
          <b-tabs v-model="activeTab" expanded class="box" size="is-medium">
            <b-tab-item label="Stake" component="button">
              ...
              <b-field grouped label="Tokens to stake" class="mt-6">
                <p class="control">
                  <b-select placeholder="EDEN" size="is-medium" v-model="selectedToken" disabled>
                      <option
  ...
  export default {
    ...
    methods: {
      ...
      formatTokenBalance(value) {
        return `${this.to2DpAndCurrencyFormatted(value)} EDEN`;
      },
