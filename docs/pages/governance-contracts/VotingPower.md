...
# Function `initialize(address _edenToken, address _vestingContract)` {#VotingPower-initialize-address-address-}
...
Stake EDEN tokens to unlock voting power for `msg.sender`
